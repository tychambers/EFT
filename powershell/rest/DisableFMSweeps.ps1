#Disables all FM sweeps, will set other FolderMonitorParams to default (sweep time, subdirectory, login, archive, etc)
...
"{
    'data': {
        ...
        'attributes': {
            'trigger': {
                'FolderMonitorParams': {'Path': '$path2slash', 'UseFolderSweep': false}
            }
        }
    }
 }"
