...
$eventrules = Invoke-RestMethod -Uri "$baseURL/v2/sites/$siteID/filesystem/folders" -Method 'GET' -Headers $authHeader

Write-Output $eventrules.data[0] | ConvertTo-Json
