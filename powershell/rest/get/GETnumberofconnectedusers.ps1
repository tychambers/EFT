...
$get_site = Invoke-RestMethod -Uri "$baseURL/v2/sites/$siteID/metrics" -Method 'GET' -Headers $authHeader


$connected_users = $get_site.data.attributes.nodes.connectedUserCount

Write-Output "current number of connected users: $connected_users"
